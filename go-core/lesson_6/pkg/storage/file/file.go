...
func (s *Storage) Write(records []model.Record, index model.InvIndex) error {
...
func (s *Storage) Read() ([]model.Record, model.InvIndex, error) {
	records, err := s.readRecords()
	if err != nil {
		return records, model.InvIndex{}, err
	}
...
func (s *Storage) writeInvertedIndex(index model.InvIndex) error {
...
func (s *Storage) readInvertedIndex() (model.InvIndex, error) {
